...
//        // ======================================================================
//        // ======================================================================
//        // 7. التوزيع التلقائي الشامل والذكي للطلاب بناءً على توزيع اللجان 🚀
//        // ======================================================================
    ...
    public class StudentsController : Controller
    {
        ...
        public async Task<IActionResult> DistributeStudents()
        {
            ...
            if (totalAssigned > 0)
            {
                ...
                if (totalAssigned < allStudents.Count)
                    TempData["InfoMessage"] = $"تم تسكين عدد {totalAssigned} طالب بنجاح، ويوجد عدد {allStudents.Count - totalAssigned} طالب بحاجة لإنشاء لجان إضافية.";
                else
                    TempData["SuccessMessage"] = $"نجاح التوزيع الشامل: تم تسكين وتوزيع جميع الطلاب البالغ عددهم ({totalAssigned}) طالب على لجانهم الامتحانية 🚀.";
            }
            else
            {
                TempData["ErrorMessage"] = "فشل التوزيع التلقائي: سعة اللجان الحالية ممتلئة بالكامل، يرجى زيادة سعة المقاعد للجان القائمة.";
